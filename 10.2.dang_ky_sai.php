...
<body>
    ...
    <h1 class="text-center" id="h1_xacnhan">&nbsp; QUÝ KHÁCH ĐÃ NHẬP SAI ĐỊNH DẠNG EMAIL</h1>
    <p class="text-center">Nhấn vào nút bên dưới để quay lại trang đăng ký</p><a class="btn btn-primary" role="button" id="btn_xacnhan" href="10.dang_ky.php">QUAY VỀ</a>
