...
<body>
    ...
    <div id="wrapper">
        <div class="container">
            <div class="row justify-content-around"><form action="login.php" method="get" class="col-md-6 bg-light p-3 my-3">
        ...
        <input name="login" id="login" type="submit" class="block" value="Đăng nhập"><br>
        <a name="qtk" id=qtk role="button"  href="13.qutkmk.php">Quên mật khẩu</a>
                </form></div>
        </div>
    </div>
