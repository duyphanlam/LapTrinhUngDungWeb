...
<body>
    ...
    <h1 class="text-center" id="h1_xacnhan">&nbsp; THÔNG TIN ĐĂNG NHẬP CỦA QUÝ KHÁCH KHÔNG TỒN TẠI TRONG HỆ THỐNG</h1>
    <p class="text-center">Nhấn vào nút bên dưới để quay về trang đăng nhập</p><a class="btn btn-primary" role="button" id="btn_xacnhan" href="11.dang_nhap.php">ĐĂNG NHẬP</a>
