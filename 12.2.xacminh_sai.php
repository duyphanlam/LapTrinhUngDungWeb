...
<body>
    ...
    <p class="text-center">Nhấn vào nút bên dưới để quay lại trang xác minh</p><a class="btn btn-primary" role="button" id="btn_xacnhan" href="12.xac_minh.php">QUAY LẠI</a>
