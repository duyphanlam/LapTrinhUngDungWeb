...
<body>
    ...
    <div id="wrapper">
        <div class="container">
            <div class="row justify-content-around"><form action="forget.php" method="POST" class="col-md-6 bg-light p-3 my-3">
                    <h1 class="text-center text-uppercase h3 py-3">QUÊN TÀI KHOẢN, MẬT KHẨU</h1>
        ...
        <input name="forget" id="forget" type="submit" class="block" value="XÁC MINH"><br>
                </form></div>
        </div>
    </div>
