...
<body>
    ...
    <h1 class="text-center" id="h1_xacnhan">&nbsp; MÃ XÁC MINH QUÝ KHÁCH NHẬP KHÔNG KHỚP TRONG HỆ THỐNG</h1>
    <p class="text-center">Nhấn vào nút bên dưới để quay lại trang xác minh</p><a class="btn btn-primary" role="button" id="btn_xacnhan" href="14.xacminhmk.php">QUAY LẠI</a>
