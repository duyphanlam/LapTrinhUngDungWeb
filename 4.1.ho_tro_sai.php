...
<body>
    ...
    <h1 class="text-center" id="h1_xacnhan">&nbsp; QUÝ KHÁCH CHƯA NHẬP NÔI DUNG CẦN ĐƯỢC HỖ TRỢ</h1>
    <p class="text-center">Nhấn vào nút bên dưới để quay về trang hỗ trợ</p><a class="btn btn-primary" role="button" id="btn_xacnhan" href="4.ho_tro.php">QUAY VỀ</a>
