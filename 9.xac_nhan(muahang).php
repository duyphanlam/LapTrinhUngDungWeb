...
<body>
    ...
    <h1 class="text-center" id="h1_xacnhan">QUÝ KHÁCH ĐÃ MUA HÀNG THÀNH CÔNG</h1>
    <p class="text-center">Nhấn vào nút bên dưới để quay về trang chọn loại giày</p><a class="btn btn-primary" role="button" id="btn_xacnhan" href="2.giay.php">QUAY VỀ</a>
